  ...
  return (
    <div className="border-b border-slate-100 pb-5">
      ...
      >
        {steps.map((step, index) => {
          ...
          return (
            <button
              ...
              className={`relative flex items-center gap-2 pb-2 text-sm font-semibold transition ${
                isAvaliacaoSuccess
                  ? "text-emerald-600"
                  : isActive
                  ? "text-primary"
        ...
        {indicatorStyle ? (
          <span
            className={`pointer-events-none absolute bottom-0 left-0 h-[3px] rounded-full transition-all duration-300 ease-in-out ${
